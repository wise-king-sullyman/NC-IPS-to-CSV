...
#get input from user
fileToOpen = 'C:\\Users\\Austin\\Documents\\Yolos\\YoloRecord.csv' #askopenfilename()
...
def yoloRecordSearch(fileToOpen):
    expiration = '3/27/2020' #str(input("Expiration date? "))
    ticker = 'GM' #str(input("Ticker? ")).upper()
    optionType = 'Put' #str(input("Put or Call? "))
    strike = '15.00' #str(input("Strike? "))
